    	...
    	shapes = new Shape[]
    	    {
               ...
               new Rect    (230,  40,  20, 60, Color.BLUE),
               new Rect    (330,  40,  80, 45,  Color.GREEN.darker()),
               new Rect    (130, 140, 100, 32, new Color (0.8f, 0.6f, 0.2f)),
    	       new Rect    ( 30, 140,  40, 43, Color.YELLOW),
